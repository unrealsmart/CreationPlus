...
class AdminPageController extends AdminBaseController
{
    ...
    public function add()
    {
        ...
        $pageThemeFiles = $themeModel->getActionThemeFiles('books/Page/index');
    ...
    public function addPost()
    {
        ...
        $booksPostModel->adminAddPage($data['post']);
        $this->success(lang('ADD_SUCCESS'), url('AdminPage/edit', ['id' => $booksPostModel->id]));
    ...
    public function edit()
    {
        ...
        $alias              = $routeModel->getUrl('books/Page/index', ['id' => $id]);
    ...
    public function editPost()
    {
        ...
        $booksPostModel->adminEditPage($data['post']);
    ...
    public function delete()
    {
        ...
        $result = $booksPostModel->adminDeletePage($data);
        if ($result) {
